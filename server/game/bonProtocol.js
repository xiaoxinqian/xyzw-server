...
// CommonJS 导出
module.exports = {
  Int64, DataReader, DataWriter, BonEncoder, BonDecoder,
  bon, ProtoMsg, ProtoMsgLegion, getEnc, encode, parse,
  GameMessages, g_utils, bonProtocol, LXCrypto, XCrypto, XTMCrypto
};
